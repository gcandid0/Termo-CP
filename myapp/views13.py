...
def ask_known1_view13(request):
    ...
    return render(request, 'amonia-estado-1.html', {'form': form})
...
def ask_known2_view13(request):
    ...
    return render(request, 'amonia-estado-2.html', {'form': form})
...
def process_values_view13(request):
    ...
    try:
        ...
        return render(request, 'results-amonia-estado-3.html', {
            'fase': fase,
