...
def ask_known1_view14(request):
    ...
    return render(request, 'amonia-propriedade-1.html', {'form': form})
...
def ask_known2_view14(request):
    ...
    return render(request, 'amonia-propriedade-2.html', {'form': form})
...
def process_values_view14(request):
    ...
    try:
        ...
        return render(request, 'results-amonia-propriedade-3.html', {
            'fase': fase,
