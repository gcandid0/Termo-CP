...
def ask_known1_view15(request):
    ...
    return render(request, 'amonia-pcte-1.html', {'form': form})
...
def ask_known2_view15(request):
    ...
    return render(request, 'amonia-pcte-2.html', {'form': form})
...
def ask_known3_view15(request):
    ...
    return render(request, 'amonia-pcte-3.html', {'form': form})
...
def ask_known4_view15(request):
    ...
    return render(request, 'amonia-pcte-4.html', {'form': form})
...
def process_values_view15(request):
    ...
    try:
        ...
        return render(request, 'results-amonia-pcte-5.html', {
            'fase': fase,
