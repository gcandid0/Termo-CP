...
def ask_known1_view17(request):
    ...
    return render(request, 'amonia-vcte-1.html', {'form': form})
...
def ask_known2_view17(request):
    ...
    return render(request, 'amonia-vcte-2.html', {'form': form})
...
def ask_known3_view17(request):
    ...
    return render(request, 'amonia-vcte-3.html', {'form': form})
...
def ask_known4_view17(request):
    ...
    return render(request, 'amonia-vcte-4.html', {'form': form})
...
def process_values_view17(request):
    ...
    try:
        ...
        return render(request, 'results-amonia-vcte-5.html', {
            'fase': fase,
