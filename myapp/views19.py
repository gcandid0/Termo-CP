...
def ask_known1_view19(request):
    ...
    return render(request, 'co2-propriedade-1.html', {'form': form})
...
def ask_known2_view19(request):
    ...
    return render(request, 'co2-propriedade-2.html', {'form': form})
...
def process_values_view19(request):
    ...
    try:
        ...
        return render(request, 'results-co2-propriedade-3.html', {
            'fase': fase,
