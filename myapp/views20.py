...
def ask_known1_view20(request):
    ...
    return render(request, 'co2-pcte-1.html', {'form': form})
...
def ask_known2_view20(request):
    ...
    return render(request, 'co2-pcte-2.html', {'form': form})
...
def ask_known3_view20(request):
    ...
    return render(request, 'co2-pcte-3.html', {'form': form})
...
def ask_known4_view20(request):
    ...
    return render(request, 'co2-pcte-4.html', {'form': form})
...
def process_values_view20(request):
    ...
    try:
        ...
        return render(request, 'results-co2-pcte-5.html', {
            'fase': fase,
