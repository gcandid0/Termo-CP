...
def ask_known1_view21(request):
    ...
    return render(request, 'co2-scte-1.html', {'form': form})
...
def ask_known2_view21(request):
    ...
    return render(request, 'co2-scte-2.html', {'form': form})
...
def ask_known3_view21(request):
    ...
    return render(request, 'co2-scte-3.html', {'form': form})
...
def process_values_view21(request):
    ...
    try:
        ...
        return render(request, 'results-co2-scte-4.html', {
            'fase': fase,
