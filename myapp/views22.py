...
def ask_known1_view22(request):
    ...
    return render(request, 'co2-vcte-1.html', {'form': form})
...
def ask_known2_view22(request):
    ...
    return render(request, 'co2-vcte-2.html', {'form': form})
...
def ask_known3_view22(request):
    ...
    return render(request, 'co2-vcte-3.html', {'form': form})
...
def ask_known4_view22(request):
    ...
    return render(request, 'co2-vcte-4.html', {'form': form})
...
def process_values_view22(request):
    ...
    try:
        ...
        return render(request, 'results-co2-vcte-5.html', {
            'fase': fase,
