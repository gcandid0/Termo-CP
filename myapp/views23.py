...
def ask_known1_view23(request):
    ...
    return render(request, 'R410A-estado-1.html', {'form': form})
...
def ask_known2_view23(request):
    ...
    return render(request, 'R410A-estado-2.html', {'form': form})
...
def process_values_view23(request):
    ...
    try:
        ...
        return render(request, 'results-R410A-estado-3.html', {
            'fase': fase,
