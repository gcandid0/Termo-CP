...
def ask_known1_view24(request):
    ...
    return render(request, 'R410A-propriedade-1.html', {'form': form})
...
def ask_known2_view24(request):
    ...
    return render(request, 'R410A-propriedade-2.html', {'form': form})
...
def process_values_view24(request):
    ...
    try:
        ...
        return render(request, 'results-R410A-propriedade-3.html', {
            'fase': fase,
