...
def ask_known1_view25(request):
    ...
    return render(request, 'R410A-pcte-1.html', {'form': form})
...
def ask_known2_view25(request):
    ...
    return render(request, 'R410A-pcte-2.html', {'form': form})
...
def ask_known3_view25(request):
    ...
    return render(request, 'R410A-pcte-3.html', {'form': form})
...
def ask_known4_view25(request):
    ...
    return render(request, 'R410A-pcte-4.html', {'form': form})
...
def process_values_view25(request):
    ...
    try:
        ...
        return render(request, 'results-R410A-pcte-5.html', {
            'fase': fase,
