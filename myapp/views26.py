...
def ask_known1_view26(request):
    ...
    return render(request, 'R410A-scte-1.html', {'form': form})
...
def ask_known2_view26(request):
    ...
    return render(request, 'R410A-scte-2.html', {'form': form})
...
def ask_known3_view26(request):
    ...
    return render(request, 'R410A-scte-3.html', {'form': form})
...
def process_values_view26(request):
    ...
    try:
        ...
        return render(request, 'results-R410A-scte-4.html', {
            'fase': fase,
