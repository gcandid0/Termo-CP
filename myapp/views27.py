...
def ask_known1_view27(request):
    ...
    return render(request, 'R410A-vcte-1.html', {'form': form})
...
def ask_known2_view27(request):
    ...
    return render(request, 'R410A-vcte-2.html', {'form': form})
...
def ask_known3_view27(request):
    ...
    return render(request, 'R410A-vcte-3.html', {'form': form})
...
def ask_known4_view27(request):
    ...
    return render(request, 'R410A-vcte-4.html', {'form': form})
...
def process_values_view27(request):
    ...
    try:
        ...
        return render(request, 'results-R410A-vcte-5.html', {
            'fase': fase,
