...
def ask_known1_view34(request):
    ...
    return render(request, 'kelvin-propriedade-1.html', {'form': form})
...
def ask_known2_view34(request):
    ...
    return render(request, 'kelvin-propriedade-2.html', {'form': form})
...
def process_values_view34(request):
    ...
    try:
        ...
        return render(request, 'results-nitrogenio-propriedade-3.html', {
            'fase': fase,
