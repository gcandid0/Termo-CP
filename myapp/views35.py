...
def ask_known1_view35(request):
    ...
    return render(request, 'kelvin-pcte-1.html', {'form': form})
...
def ask_known2_view35(request):
    ...
    return render(request, 'kelvin-pcte-2.html', {'form': form})
...
def ask_known3_view35(request):
    ...
    return render(request, 'kelvin-pcte-3.html', {'form': form})
...
def ask_known4_view35(request):
    ...
    return render(request, 'kelvin-pcte-4.html', {'form': form})
...
def process_values_view35(request):
    ...
    try:
        ...
        return render(request, 'results-nitrogenio-pcte-5.html', {
            'fase': fase,
