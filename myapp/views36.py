...
def ask_known1_view36(request):
    ...
    return render(request, 'kelvin-scte-1.html', {'form': form})
...
def ask_known2_view36(request):
    ...
    return render(request, 'kelvin-scte-2.html', {'form': form})
...
def ask_known3_view36(request):
    ...
    return render(request, 'kelvin-scte-3.html', {'form': form})
...
def process_values_view36(request):
    ...
    try:
        ...
        return render(request, 'results-nitrogenio-scte-4.html', {
            'fase': fase,
