...
def ask_known1_view37(request):
    ...
    return render(request, 'kelvin-vcte-1.html', {'form': form})
...
def ask_known2_view37(request):
    ...
    return render(request, 'kelvin-vcte-2.html', {'form': form})
...
def ask_known3_view37(request):
    ...
    return render(request, 'kelvin-vcte-3.html', {'form': form})
...
def ask_known4_view37(request):
    ...
    return render(request, 'kelvin-vcte-4.html', {'form': form})
...
def process_values_view37(request):
    ...
    try:
        ...
        return render(request, 'results-nitrogenio-vcte-5.html', {
            'fase': fase,
