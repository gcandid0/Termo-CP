...
def ask_known1_view38(request):
    ...
    return render(request, 'kelvin-estado-1.html', {'form': form})
...
def ask_known2_view38(request):
    ...
    return render(request, 'kelvin-estado-2.html', {'form': form})
...
def process_values_view38(request):
    ...
    try:
        ...
        return render(request, 'results-metano-estado-3.html', {
            'fase': fase,
