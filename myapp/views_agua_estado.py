...
def ask_known1_view(request):
    ...
    return render(request, 'agua/agua-estado-1.html', {'form': form})
...
def ask_known2_view(request):
    ...
    return render(request, 'agua/agua-estado-2.html', {'form': form})
...
def process_values_view(request):
    ...
    try:
        ...
        return render(request, 'agua/results-agua-estado-3.html', {
            'fase': fase,
