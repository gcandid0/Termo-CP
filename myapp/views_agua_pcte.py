...
def ask_known1_view3(request):
    ...
    estados.limpar_estados()  # limpa a lista do backend
    ...
    return render(request, 'agua/agua-pcte-1.html', {'form': form})
...
def ask_known2_view3(request):
    ...
    return render(request, 'agua/agua-pcte-2.html', {'form': form})
...
def ask_known3_view3(request):
    ...
    return render(request, 'agua/agua-pcte-3.html', {'form': form})
...
def ask_known4_view3(request):
    ...
    return render(request, 'agua/agua-pcte-4.html', {'form': form})
...
def process_values_view3(request):
    ...
    try:
        ...
        pontos_criticos = []
        try:
            h_sat_l = agua_cls(1, 1, 6, pressao, 0)
            h_sat_v = agua_cls(1, 1, 6, pressao, 100)
        ...
        for val_atual in valores_iteracao:
            try:
                h_micro = agua_cls(1, 1, 4, pressao, val_atual)
        ...
        return render(request, 'agua/results-agua-pcte-5.html', {
            'fase': fase,
