...
def ask_known1_view4(request):
    ...
    return render(request, 'agua/agua-scte-1.html', {'form': form})
...
def ask_known2_view4(request):
    ...
    return render(request, 'agua/agua-scte-2.html', {'form': form})
...
def ask_known3_view4(request):
    ...
    return render(request, 'agua/agua-scte-3.html', {'form': form})
...
import math # Certifique-se de que o import math esteja no topo do arquivo
