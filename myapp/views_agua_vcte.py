...
def ask_known1_view5(request):
    ...
    return render(request, 'agua/agua-vcte-1.html', {'form': form})
...
def ask_known2_view5(request):
    ...
    return render(request, 'agua/agua-vcte-2.html', {'form': form})
...
def ask_known3_view5(request):
    ...
    return render(request, 'agua/agua-vcte-3.html', {'form': form})
...
def ask_known4_view5(request):
    ...
    return render(request, 'agua/agua-vcte-4.html', {'form': form})
