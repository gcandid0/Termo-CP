...
def processos_view13(request):
    return render(request, 'processos3.html')

###############################################################################

def ask_known1_view13(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known2_13')
    else:
        form = PropertyFormAmoniaEst1()

    return render(request, 'amonia/amonia-estado-1.html', {'form': form})

###############################################################################

def ask_known2_view13(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('process_values_13')
    else:
        excluded_properties = [int(request.session.get('property_choice', 0))]
        form = SecondPropertyFormAmoniaEst1(excluded_properties=excluded_properties)

    return render(request, 'amonia/amonia-estado-2.html', {'form': form})
...
def process_values_view13(request):
    ...
    try:
        ...
        return render(request, 'amonia/results-amonia-estado-3.html', {
            'fase': fase,
...
def error_value_view13(request):
