...
def ask_known1_view16(request):
    ...
    return render(request, 'amonia/amonia-scte-1.html', {'form': form})
...
def ask_known2_view16(request):
    ...
    return render(request, 'amonia/amonia-scte-2.html', {'form': form})
...
def ask_known3_view16(request):
    ...
    return render(request, 'amonia/amonia-scte-3.html', {'form': form})
