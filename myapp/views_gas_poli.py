...
def ask_known1_view11(request):
    ...
    return render(request, 'gas/ask_known1_11.html', {'form': form})
...
def ask_known2_view11(request):
    ...
    return render(request, 'gas/ask_known2_11.html', {'form': form})
...
def ask_known3_view11(request):
    if request.method == 'POST':
        ...
        form = Prop1Poli11()
    return render(request, 'gas/ask_known3_11.html', {'form': form})
...
def ask_known4_view11(request):
    ...
    return render(request, 'gas/ask_known4_11.html', {'form': form})
...
def ask_known5_view11(request):
    if request.method == 'POST':
        ...
        form = Prop2TCte11()
    return render(request, 'gas/ask_known5_11.html', {'form': form})
...
def ask_known6_view11(request):
    if request.method == 'POST':
        ...
        form = NGasIdeal11()
    return render(request, 'gas/ask_known6_11.html', {'form': form})
...
def ask_known7_view11(request):
    if request.method == 'POST':
        ...
        form = TvizGasIdeal11()
    return render(request, 'gas/ask_known7_11.html', {'form': form})
