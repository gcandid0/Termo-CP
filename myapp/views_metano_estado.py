...
def processos_view38(request):
    return render(request, 'processos8.html')

###############################################################################

def ask_known1_view38(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known2_38')
    else:
        form = PropertyFormKelvinEst1()

    return render(request, 'metano/mkelvin-estado-1.html', {'form': form})

###############################################################################

def ask_known2_view38(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('process_values_38')
    else:
        excluded_properties = [int(request.session.get('property_choice', 0))]
        form = SecondPropertyFormKelvinEst1(excluded_properties=excluded_properties)

    return render(request, 'metano/mkelvin-estado-2.html', {'form': form})
...
def process_values_view38(request):
    ...
    try:
        ...
        return render(request, 'metano/results-metano-estado-3.html', {
            'fase': fase,
...
def error_value_view38(request):
