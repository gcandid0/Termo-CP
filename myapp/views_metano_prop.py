...
def processos_view39(request):
    return render(request, 'processos6.html')

###############################################################################

def ask_known1_view39(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known2_39')
    else:
        form = PropertyFormKelvinEst1()

    return render(request, 'metano/mkelvin-propriedade-1.html', {'form': form})

###############################################################################

def ask_known2_view39(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('process_values_39')
    else:
        excluded_properties = [int(request.session.get('property_choice', 0))]
        form = SecondPropertyFormKelvinEst1(excluded_properties=excluded_properties)

    return render(request, 'metano/mkelvin-propriedade-2.html', {'form': form})
...
def process_values_view39(request):
    ...
    try:
        ...
        return render(request, 'metano/results-metano-propriedade-3.html', {
            'fase': fase,
...
def error_value_view39(request):
