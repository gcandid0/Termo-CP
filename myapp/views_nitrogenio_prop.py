...
def processos_view34(request):
    return render(request, 'processos6.html')

###############################################################################

def ask_known1_view34(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known2_34')
    else:
        form = PropertyFormKelvinEst1()

    return render(request, 'nitrogenio/nkelvin-propriedade-1.html', {'form': form})

###############################################################################

def ask_known2_view34(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('process_values_34')
    else:
        excluded_properties = [int(request.session.get('property_choice', 0))]
        form = SecondPropertyFormKelvinEst1(excluded_properties=excluded_properties)

    return render(request, 'nitrogenio/nkelvin-propriedade-2.html', {'form': form})
...
def process_values_view34(request):
    ...
    try:
        ...
        return render(request, 'nitrogenio/results-nitrogenio-propriedade-3.html', {
            'fase': fase,
...
def error_value_view34(request):
