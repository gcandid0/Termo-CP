...
def homepage_view37(request):
    return render(request, 'Inicio.html')

###############################################################################

def ask_known1_view37(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known2_37')
    else:
        form = vcteKelvin()

    return render(request, 'nitrogenio/nkelvin-vcte-1.html', {'form': form})

###############################################################################

def ask_known2_view37(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known3_37')
    else:
        form = vcteKelvin2(excluded_properties=excluded_properties)

    return render(request, 'nitrogenio/nkelvin-vcte-2.html', {'form': form})

###############################################################################

def ask_known3_view37(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known4_37')
    else:
        form = vcteKelvin3()

    return render(request, 'nitrogenio/nkelvin-vcte-3.html', {'form': form})

###############################################################################

def ask_known4_view37(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('process_values_37')
    else:
        form = vcteKelvin4()

    return render(request, 'nitrogenio/nkelvin-vcte-4.html', {'form': form})
...
def process_values_view37(request):
    ...
    try:
        ...
        # O formulário vcteKelvin4 fornece:
        ...
        h = subs_cls(6, third_property_choice, 2, third_value_input, volume_esp)
        ...
        entropia_ger = round((entropia_esp2 - entropia_esp) - (calor / (temp_viz + 373.15)), 6)
        trabalho = 0
        ...
        return render(request, 'nitrogenio/results-nitrogenio-vcte-5.html', {
            'fase': fase,
