...
def processos_view28(request):
    return render(request, 'processos6.html')

###############################################################################

def ask_known1_view28(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known2_28')
    else:
        form = PropertyFormR410AEst1()

    return render(request, 'R134A/R134A-estado-1.html', {'form': form})

###############################################################################

def ask_known2_view28(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('process_values_28')
    else:
        excluded_properties = [int(request.session.get('property_choice', 0))]
        form = SecondPropertyFormR410AEst1(excluded_properties=excluded_properties)

    return render(request, 'R134A/R134A-estado-2.html', {'form': form})
...
def process_values_view28(request):
    ...
    try:
        ...
        return render(request, 'R134A/results-R134A-estado-3.html', {
            'fase': fase,
...
def error_value_view28(request):
