...
def homepage_view30(request):
    return render(request, 'Inicio.html')

###############################################################################

def ask_known1_view30(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known2_30')
    else:
        form = PcteR410A()

    return render(request, 'R134A/R134A-pcte-1.html', {'form': form})

###############################################################################

def ask_known2_view30(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known3_30')
    else:
        form = PcteR410A2(excluded_properties=excluded_properties)

    return render(request, 'R134A/R134A-pcte-2.html', {'form': form})

###############################################################################

def ask_known3_view30(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known4_30')
    else:
        form = PcteR410A3()

    return render(request, 'R134A/R134A-pcte-3.html', {'form': form})


###############################################################################

def ask_known4_view30(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('process_values_30')
    else:
        form = PcteR410A4()

    return render(request, 'R134A/R134A-pcte-4.html', {'form': form})
...
def process_values_view30(request):
    ...
    try:
        ...
        return render(request, 'R134A/results-R134A-pcte-5.html', {
            'fase': fase,
...
def error_value_view30(request):
