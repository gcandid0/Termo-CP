# -*- coding: utf-8 -*-
"""
Created on Tue Apr 14 29:14:36 2026
...
def ask_known1_view29(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known2_29')
    else:
        form = PropertyFormR410AEst1()

    return render(request, 'R134A/R134A-propriedade-1.html', {'form': form})

###############################################################################

def ask_known2_view29(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('process_values_29')
    else:
        excluded_properties = [int(request.session.get('property_choice', 0))]
        form = SecondPropertyFormR410AEst1(excluded_properties=excluded_properties)

    return render(request, 'R134A/R134A-propriedade-2.html', {'form': form})
...
def process_values_view29(request):
    ...
    try:
        ...
        return render(request, 'R134A/results-R134A-propriedade-3.html', {
            'fase': fase,
...
def error_value_view29(request):
