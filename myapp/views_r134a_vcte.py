...
def homepage_view32(request):
    return render(request, 'Inicio.html')

###############################################################################

def ask_known1_view32(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known2_32')
    else:
        form = vcteR410A()

    return render(request, 'R134A/R134A-vcte-1.html', {'form': form})

###############################################################################

def ask_known2_view32(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known3_32')
    else:
        form = vcteR410A2(excluded_properties=excluded_properties)

    return render(request, 'R134A/R134A-vcte-2.html', {'form': form})

###############################################################################

def ask_known3_view32(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ask_known4_32')
    else:
        form = vcteR410A3()

    return render(request, 'R134A/R134A-vcte-3.html', {'form': form})

###############################################################################

def ask_known4_view32(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('process_values_32')
    else:
        form = vcteR410A4()

    return render(request, 'R134A/R134A-vcte-4.html', {'form': form})
...
def process_values_view32(request):
    ...
    try:
        ...
        h = subs_cls(5, third_property_choice, 2, third_value_input, volume_esp)
        ...
        entropia_ger = round((entropia_esp2 - entropia_esp) - (calor / (temp_viz + 323.15)), 6)
        trabalho = 0
        ...
        return render(request, 'R134A/results-R134A-vcte-5.html', {
            'fase': fase,
        ...
        return render(request, 'error_type32.html', {'message': str(e)})
    except Exception:
