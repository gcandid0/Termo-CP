...
def process_values_view26(request):
    ...
    try:
        ...
        if third_property_choice == 7:
            ...
            h = subs_cls(4, 1, 4, pressao, energia_int3)
        ...
        if cruzou_domo:
            ...
            for _ in range(60):
                ...
                try:
                    if is_isobaric:
                        h_mid = subs_cls(4, 1, 4, fixo_val, val_mid)
                    else:
                        h_mid = subs_cls(4, 1, 5, val_mid, fixo_val)
            ...
            try:
                if is_isobaric:
                    h_front_calc = subs_cls(4, 1, 4, fixo_val, val_front)
                else:
                    h_front_calc = subs_cls(4, 1, 5, val_front, fixo_val)
